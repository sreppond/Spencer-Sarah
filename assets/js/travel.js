...
(function () {
  ...
  /* Every root-relative path in config.js/travel-data.js (the photos) is
     written for index.html at the site root; this page always lives one
     level down at /travel/, so every one of those strings needs the
