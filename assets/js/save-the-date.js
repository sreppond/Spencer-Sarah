...
(function () {
  ...
  /* ------------------------------------------------------------------
     ...
     (0 → 1 across a 118svh runway) so CSS could lift the copy, fade it
     out and climb an ivory wash over a pinned painting; the hero is one
     ordinary screen now and simply scrolls away.
